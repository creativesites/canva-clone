...
export const addCurriculumName = (name: string) => ({
  rootId: 'f2d33316-8857-4496-a0c7-3dcc9c4ff981',
  layers: {
    'f2d33316-8857-4496-a0c7-3dcc9c4ff981': {
      type: { resolvedName: 'TextLayer' },
      props: {
        text: `<p style="text-align: center;font-family: Roboto;font-size: 68px;color: rgb(0, 0, 0);line-height: 1.4;letter-spacing: 0em;"><strong><span style="color: rgb(0, 0, 0);">${name}</span></strong></p>`,
        position: { x: 525.12102340009, y: 261.582179409994 },
        boxSize: {
          width: 536.3009995574356,
          height: 95,
...
export const addGoal = (goal: string) => ({
  rootId: '9cc89a8c-49d5-4f90-9964-f65bbe90db92',
  layers: {
    '9cc89a8c-49d5-4f90-9964-f65bbe90db92': {
      type: { resolvedName: 'TextLayer' },
      props: {
        text: `<p style="text-align: center;font-family: Roboto;font-size: 38px;color: rgb(0, 0, 0);line-height: 1.4;letter-spacing: 0em;"><strong><span style="color: rgb(0, 0, 0);">${goal}</span></strong></p>`,
        position: { x: 519.12102340009, y: 365.582179409994 },
        boxSize: {
          width: 536.3009995574356,
          height: 53,
